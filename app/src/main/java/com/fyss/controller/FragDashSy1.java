...
public class FragDashSy1 extends Fragment {
     ...
     * @return A new instance of fragment FragDashSy1.
     */
    // TODO: Rename and change types and number of parameters
    public static FragDashSy1 newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button profileBtn = frag1.findViewById(R.id.profileBtn);

        profileBtn.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(getActivity(), SyProfileActivity.class);
        ...
        //return inflater.inflate(R.layout.fragment_frag_dash_sy1, container, false);
    }
