...
import com.fyss.R;
import com.fyss.controller.ui.dashboard.MeetingsAdapter;
 ...
 * {@link FragDashSy2.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragDashSy2#newInstance} factory method to
...
public class FragDashSy2 extends Fragment {
    ...
    private List<GroupMeeting> meetingsList = new ArrayList<>();
     ...
     * @return A new instance of fragment FragDashSy2.
     */
    // TODO: Rename and change types and number of parameters
    public static FragDashSy2 newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_frag_dash_sy2, container, false);
    }


    private void prepareMeetingsData(){
        GroupMeeting g = new GroupMeeting();
        g.setWeekNum(1);
        g.setRoom("S12");
        g.setBuilding("Schumann");
        g.setGMDate("2020-15-12T14:00");
        meetingsList.add(g);
